  ...
  return (
    <div className="w-full py-16 bg-(--light-primary) dark:bg-(--dark-primary) text-(--light-on-primary) dark:text-(--dark-on-primary) relative">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex 2xl:flex-row justify-center 2xl:items-start mt-10 2xl:gap-x-40 xl:gap-x-30 gap-x-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <a className="text-lg hover:underline underline-offset-3 opacity-60"
